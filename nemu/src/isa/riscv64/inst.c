...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  //bubble-sort
  INSTPAT("0000000 ????? ????? 001 ????? 00100 11", slli   , I, R(dest) = (unsigned)src1 << BITS(src2,5,0));
  INSTPAT("0000000 ????? ????? 101 ????? 00100 11", srli   , I, R(dest) = (unsigned)src1 >> BITS(src2,5,0));
  ...
  INSTPAT("0100000 ????? ????? 101 ????? 00100 11", srai   , I, R(dest) = (signed)src1 >> BITS(src2,5,0) );
