...
VL_INLINE_OPT void Vtop___024root___sequent__TOP__3(Vtop___024root* vlSelf) {
    ...
    vlSelf->pc = ((IData)(vlSelf->rstn) ? ((IData)(4U) 
                   ...
                   : 0x80000000U);
    if (vlSelf->rstn) {
        vlSelf->top__DOT__add = vlSelf->top__DOT__u_idu__DOT__addi;
    }
    if (vlSelf->rstn) {
        vlSelf->top__DOT__rs1 = ((IData)(vlSelf->top__DOT__u_idu__DOT__addi)
                                  ? (0x1fU & (vlSelf->inst 
                                              >> 0xfU))
                                  : 0U);
        vlSelf->top__DOT__imm_I = ((IData)(vlSelf->top__DOT__u_idu__DOT__addi)
                                    ? (((- (QData)((IData)(
                                                           (vlSelf->inst 
                                                            >> 0x1fU)))) 
                                        << 0xcU) | (QData)((IData)(
    ...
    vlSelf->top__DOT__reg_wr = ((IData)(vlSelf->rstn) 
                                & (IData)(vlSelf->top__DOT__u_idu__DOT__addi));
    vlSelf->top__DOT__rd = ((IData)(vlSelf->rstn) ? 
                            ((IData)(vlSelf->top__DOT__u_idu__DOT__addi)
                              ? (0x1fU & (vlSelf->inst 
                                          >> 7U)) : 0U)
                             : 0U);
