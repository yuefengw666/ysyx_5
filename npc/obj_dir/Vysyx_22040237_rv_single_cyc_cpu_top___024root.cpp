...
void Vysyx_22040237_rv_single_cyc_cpu_top___024unit____Vdpiimwrap_set_npc_state_TOP____024unit(IData/*31:0*/ state, QData/*63:0*/ pc, QData/*63:0*/ halt_ret);
    ...
    if ((1U & ((~ (IData)(vlSelf->rst)) & (~ ((((((
                                              ...
                                              | (IData)(
                                                        (0x23U 
                                                         ...
                                                         (0x7fU 
                                                          & vlSelf->inst_in)))))))) {
        Vysyx_22040237_rv_single_cyc_cpu_top___024unit____Vdpiimwrap_set_npc_state_TOP____024unit(3U, vlSelf->pc, 0xffffffffffffffffULL);
    }
    if (vlSelf->rst) {
